...
<tr> <td width="500">출판사: <%=bookList.getPublish_com() %></td></tr>
<tr> <td width="500">출판일: <%=bookList.getPublish_date() %></td></tr>
<tr> <td width="500">정가 :
<%=NumberFormat.getInstance().format(bookList.getBook_price()*((double)(100-bookList.getDiscount_rate())/100))%>
