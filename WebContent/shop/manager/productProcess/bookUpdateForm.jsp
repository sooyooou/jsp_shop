<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import = "shop.master.ShopBookDataBean" %>
	...
	<form method="post" name="writeform" action="bookUpdatePro.jsp" enctype="multipart/form-data">
		<table>
			...
			<tr>
				...
				<td width="400" align="left">
					<input type="text" size="50" maxlength="50" name="book_title" value="<%=book.getBook_title()%>">
			...
			<tr>
				...
				<td width="400" align="left">
					<input type="text" size="10" maxlength="9" name="book_price" value="<%=book.getBook_price()%>">원
				</td>
			</tr>
			<tr>
				<td width="100" bgcolor="<%=value_c%>">수량</td>
				<td width="400" align="left">
					<input type="text" size="10" maxlength="5" name="book_count" value="<%=book.getBook_count()%>">권
				</td>
			</tr>
			<tr>
				<td width="100" bgcolor="<%=value_c%>">저자</td>
				<td width="400" align="left">
					<input type="text" size="10" maxlength="5" name="author" value="<%=book.getAuthor()%>">
				</td>
			</tr>
			<tr>
				<td width="100" bgcolor="<%=value_c%>">출판사</td>
				<td width="400" align="left">
					<input type="text" size="20" maxlength="30" name="publish_com" value="<%=book.getPublish_com()%>">
				</td>
			</tr>
			<tr>
				...
				<td width="400" align="left">
					...
					%>
						<option value="<%=i%>"
						<%if(Integer.parseInt(book.getPublish_date().substring(0, 4))==i) {%> selected <%} %>><%=i %>
						</option>
						<%} %>
					</select>년
					...
					%>
						<option value="<%=i%>"
						<%if(Integer.parseInt(book.getPublish_date().substring(5, 7))==i) {%> selected <%} %>><%=i %>
						</option>
						<%} %>
					</select>월
					...
					%>
						<option value="<%=i%>"
						<%if(Integer.parseInt(book.getPublish_date().substring(8))==i) {%> selected <%} %>><%=i %>
						</option>
						<%} %>
					</select>일
				</td>
			...
			<tr>
				...
				<td width="400" align="left">
					<input type="file" name="book_image" value="<%=book.getBook_image()%>">
				</td>
			</tr>
			<tr>
